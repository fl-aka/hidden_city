...
import 'package:ta_uniska_bjm/gg/network_kominfo/pages/dashBoardMenu/itemlist.dart';
...
class Baru extends StatefulWidget {
  final String ipIs;
  const Baru({Key? key, required this.ipIs}) : super(key: key);
