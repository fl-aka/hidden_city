...
class _ProgGanListState extends State<ProgGanList> {
                  ...
                  SizedBox(
                    ...
                    child: AnimatedSwitcher(
                      transitionBuilder:
                        ...
                        return AniRotBu(i, rotate: rotate, fronts: _fronts,
                            child: child);
                      },
                                        ...
                                        SizedBox(
                                            ...
                                            child: Center(
                                              child: (widget.list![i]
                                                      ...
                                                      !checkDanger(i))
                                                  ? Image.network(
                                                      "https://${widget.ipIs}/jaringan/conn/uploads/${widget.list![i]['image']}")
                                                  : checkDanger(i)
                                                      ? _img(i)
                                                      : const Icon(
                                                          Icons.camera,
  ...
  Future<void> delData(String iD) async {
    ...
    if (lanjut) {
      ...
      try {
        Uri dophp =
            Uri.parse("https://${widget.ipIs}/jaringan/conn/doLayanan.php");
        final respone = await http.post(dophp, body: {
          'action': 'delData',
          'jenis': 'layanan',
          'key': 'CacingBernyanyi',
            ...
            child: spcButton(
              ...
              child: Row(
                children: const [
                  Text("Edit"),
                  Spacer(),
                  Icon(FontAwesomeIcons.pencil, size: 15),
                ],
              ),
            )),
      );
