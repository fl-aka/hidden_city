...
class ProgressPageGan extends StatefulWidget {
  final String ipIs;
  final Users user;
  final bool exp;
  const ProgressPageGan(
      {Key? key, required this.ipIs, required this.user, required this.exp})
      : super(key: key);

  @override
  State<ProgressPageGan> createState() => _ProgressPageGanState();
}

class _ProgressPageGanState extends State<ProgressPageGan> {
