...
class LaporGanguan extends StatefulWidget {
  final String ipIs;
  final bool exp;
  final Users user;
  const LaporGanguan(
  ...
  @override
  State<LaporGanguan> createState() => _LaporGanguanState();
}

class _LaporGanguanState extends State<LaporGanguan> {
                        ...
                        return ScrollParent(
                          ...
                          child: ListView(
                            children: [
                              ...
                              textMng("Nama Pelapor ", insideBubble),
                              textField(1, _namaCon),
                              textMng("Kontak Pelapor ", insideBubble),
                              textField(1, _kontakCon),
                              textMng("*Isi Laporan ", insideBubble),
  ...
  Future<void> subMethod(BuildContext context, String jenis) async {
    if (_petugas != "" && _instanCon.text != "" && _laporCon.text != "") {
      String kodePel = _petugas.substring(0, 2);
          ...
          if (reply == 'SucessSucess') {
            ...
            showDialog(
                ...
                builder: (builder) => AlertDialog(
                      content: const Text("Pelaporan Berhasil Ditambahkan"),
      ...
      if (_petugas == "" && _instanCon.text == "" && _laporCon.text == "") {
        ...
        if (_petugas == "" && (_instanCon.text == "" || _laporCon.text == "")) {
          ...
          if (_laporCon.text == "") {
            kosong += " dan isi laporan masih kosong";
          }
        } else if (_laporCon.text == "" && _instanCon.text == "") {
          kosong += "Instansi dan isi pelaporan kosong";
        } else {
          if (_instanCon.text == "") {
