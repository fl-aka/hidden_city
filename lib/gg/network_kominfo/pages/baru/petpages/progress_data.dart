...
class ProgGanListPet extends StatefulWidget {
  ...
  const ProgGanListPet(this.color1,
      {Key? key,
      required this.list,
      required this.ipIs,
  ...
  @override
  State<ProgGanListPet> createState() => _ProgGanListPetState();
}

class _ProgGanListPetState extends State<ProgGanListPet> {
            ...
            child: SizedBox(
              ...
              child: AnimatedSwitcher(
                transitionBuilder: (Widget child, Animation<double> animation) {
                  ...
                  return AniRotBu(i,
                      rotate: rotate, fronts: _fronts, child: child);
                },
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    const Text("Petugas"),
                                    const Spacer(),
                                    Text((widget.list![i]['petugas2'] == null)
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    const Text("Kendala"),
                                    const Spacer(),
                                    Text((widget.list![i]['kendala'] == null)
                                        ? "Tidak ada Kendala"
                                                ...
                                                doThisQuick: () async {
                                                  ...
                                                  DatasetPrint printI = DatasetPrint(
                                                      ...
                                                      petugas1: widget.list![i]
                                                          ['name'],
                                                      petugas2: (widget.list![i]['petugas_2'] != null)
                                                          ? widget.list![i]
                                                              ['petugas_2']
                                                          : "",
                                                      namaPelapor:
                                                          (widget.list![i]['nama'] != null)
                                                              ? widget.list![i]
                                                                  ['nama']
                                                              : "",
                                                      ...
                                                      deskripsi: widget.list![i]
                                                          ['deskripsi'],
                                                      tindakLanjut: widget.list![i]
                                                          ['tindakLanjut'],
                                                      tanggal: widget.list![i]
                                                          ['tanggal'],
