...
class PdfInvoiceApi {
  ...
  static pw.Widget buildTindakLanjut(String data) {
    bool telCbx = false, remCbx = false, onsCbx = false;
    List<String>? cek = [];
    int last = 0;
    ...
    return pw
      ...
      pw.Container(
          ...
          child: pw.Row(
              mainAxisAlignment: pw.MainAxisAlignment.spaceAround,
              children: [
                pw.Checkbox(name: "On Site", value: onsCbx),
                pw.Text("On Site", style: const pw.TextStyle(fontSize: 11)),
                pw.Checkbox(name: "Via Telepon", value: telCbx),
                pw.Text("Via Telepon", style: const pw.TextStyle(fontSize: 11)),
                pw.Checkbox(name: "Remote", value: remCbx),
